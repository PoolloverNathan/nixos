  ...
  wayland.windowManager.hyprland = {
    ...
    in {
      ...
      bind = rows [
        ...
        ["$meta" "Z" "movetoworkspacesilent" special:minimized]
        ["$meta SHIFT" "Z" "togglespecialworkspace" "minimized"]
        ["$meta SHIFT" "Z" "submap" "minimized"]
        ["$meta" "S" "togglespecialworkspace" "magic"]
        ["$meta SHIFT" "S" "togglespecialworkspace" special:magic]
